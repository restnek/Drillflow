...
public class DotTranslator {
    ...
    try {
      switch (wmlObj.getObjectType()) {
        case "well":
          ...
          return WellConverter.convertTo1311(
              (com.hashmapinc.tempus.WitsmlObjects.v1411.ObjWell) wmlObj);
        case "wellbore":
          if (wmlObj instanceof com.hashmapinc.tempus.WitsmlObjects.v1311.ObjWellbore)
            return wmlObj;
          return WellboreConverter.convertTo1311(
              (com.hashmapinc.tempus.WitsmlObjects.v1411.ObjWellbore) wmlObj);
        case "trajectory":
          if (wmlObj instanceof com.hashmapinc.tempus.WitsmlObjects.v1311.ObjTrajectory)
            return wmlObj;
          return TrajectoryConverter.convertTo1311(
              (com.hashmapinc.tempus.WitsmlObjects.v1411.ObjTrajectory) wmlObj);
        case "log":
          if (wmlObj instanceof com.hashmapinc.tempus.WitsmlObjects.v1311.ObjLog) return wmlObj;
          return LogConverter.convertTo1311(
              (com.hashmapinc.tempus.WitsmlObjects.v1411.ObjLog) wmlObj);
        case "fluidsreport":
          if (wmlObj instanceof com.hashmapinc.tempus.WitsmlObjects.v1311.ObjFluidsReport)
            return wmlObj;
          return FluidsReportConverter.convertTo1311(
              (com.hashmapinc.tempus.WitsmlObjects.v1411.ObjFluidsReport) wmlObj);
        default:
  ...
  public static AbstractWitsmlObject translateQueryResponse(
      AbstractWitsmlObject wmlObject, String jsonResponseString, Map<String, String> optionsIn)
      throws ValveException {
    ...
    result = result.replace("\"dtimTrajStart\":", "\"dTimTrajStart\":")
        .replace("\"dtimTrajEnd\":", "\"dTimTrajEnd\":")
        .replace("\"dtimStn\":", "\"dTimStn\":");
    // ************************************************************************************ //

    // convert the JSON response back to valid xml (it is already in the correct version)
    LOGGER.trace("Converting DoT JSON response to valid XML string");
        ...
        case "log":
          if ("1.3.1.1".equals(wmlObject.getVersion())) {
            return WitsmlMarshal.deserializeFromJSON(
                result, com.hashmapinc.tempus.WitsmlObjects.v1311.ObjLog.class);
          } else {
   ...
   *
   * @param jsonResponseString - JSON response from DoT
   * @return AbstractWitsmlObject - converted FluidsReport object to either 1.3.1.1 or 1.4.1.1 (null
   *     if not one of these versions)
   */
  public static AbstractWitsmlObject createFsRQueryResponse(
      String jsonResponseString, AbstractWitsmlObject witsmlObject)
      throws ValveException, DatatypeConfigurationException {
    ...
    LOGGER.trace("Converting DoT JSON 2.0 response to valid XML string");
    try {
      // all responses from DoT for Fluids Reports are 2.0
      // TODO --
      // jsonResponseString has: "hardnessCA":{"uom":"ppm","value":3200.0}
      // why doesn't WitsmlMarshal.deserializeFromJSON put hardnessCA into fluidsReport (it is null
      // after the marshal)
      FluidsReport fluidsReport =
          WitsmlMarshal.deserializeFromJSON(jsonResponseString, FluidsReport.class);
  ...
  /**
   * converts witsmlObjects list of wells to valid witsml XML string based on version and whether
  ...
  private static String consolidateWellsToXML(
      List<AbstractWitsmlObject> witsmlObjects, String version) throws ValveException {
    String xml;
    boolean is1411 = "1.4.1.1".equals(version);

    // handle empty well list
    if (witsmlObjects == null || witsmlObjects.isEmpty()) {
      try {
        xml =
            is1411
  ...
  /**
   * converts witsmlObjects list of wellbores to valid witsml XML string based on version and
  ...
  /**
   * converts witsmlObjects list of logs to valid witsml XML string based on version and whether the
  ...
  /**
   * converts witsmlObjects list of fluidsreports to valid witsml XML string based on version and
   * whether the list is empty or not
   *
   * @param witsmlObjects - list of objects to serialize
   * @param version - witsml version to serialize to
  ...
  /**
   * Consolidates each object under 1 parent and serializes the consolidated object into an XML
   * string in the proper WITSML version format
   *
  ...
  public static String consolidateObjectsToXML(
      List<AbstractWitsmlObject> witsmlObjects, String version, String objectType)
      throws ValveException {
    // validate version
    ...
    switch (objectType.toLowerCase()) {
      ...
      default:
        throw new ValveException(
            "Unsupported object type: " + witsmlObjects.get(0).getObjectType());
    }
  ...
  private static String consolidate1311TrajectoriesToXML(
      List<AbstractWitsmlObject> witsmlObjects) throws ValveException {
    try {
  ...
  private static String consolidate1311LogsToXML(List<AbstractWitsmlObject> witsmlObjects)
      throws ValveException {
    try {
      // get parent object from first child
  ...
  private static String consolidate1411TrajectoriesToXML(
    ...
    try {
      ...
      // consolidate children
      for (AbstractWitsmlObject child : witsmlObjects) {
        parent.addTrajectory((com.hashmapinc.tempus.WitsmlObjects.v1411.ObjTrajectory) child);
      }
  ...
  private static String consolidate1411FluidReportsToXML(
    ...
    try {
      ...
      // consolidate children
      for (AbstractWitsmlObject child : witsmlObjects) {
        parent.addFluidReport((com.hashmapinc.tempus.WitsmlObjects.v1411.ObjFluidsReport) child);
      }
  ...
  private static String consolidate1411LogsToXML(List<AbstractWitsmlObject> witsmlObjects)
      throws ValveException {
    try {
      // get parent object from first child
  ...
  private static String consolidate1311WellsToXML(List<AbstractWitsmlObject> witsmlObjects)
      throws ValveException {
    try {
      // get parent object from first child
  ...
  private static String consolidate1411WellsToXML(List<AbstractWitsmlObject> witsmlObjects)
      throws ValveException {
    try {
      // get parent object from first child
      ...
      // consolidate children
      for (AbstractWitsmlObject child : witsmlObjects) {
        parent.addWell((com.hashmapinc.tempus.WitsmlObjects.v1411.ObjWell) child);
      }
  ...
  private static String consolidate1311WellboresToXML(List<AbstractWitsmlObject> witsmlObjects)
      throws ValveException {
    try {
      // get parent object from first child
  ...
  private static String consolidate1411WellboresToXML(List<AbstractWitsmlObject> witsmlObjects)
      throws ValveException {
    try {
      // get parent object from first child
      ...
      // consolidate children
      for (AbstractWitsmlObject child : witsmlObjects) {
        parent.addWellbore((com.hashmapinc.tempus.WitsmlObjects.v1411.ObjWellbore) child);
      }
