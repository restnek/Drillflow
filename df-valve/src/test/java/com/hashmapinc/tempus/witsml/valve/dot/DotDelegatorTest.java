...
class DotDelegatorTest {
  ...
  void shouldCheckDuplicateMnemonicsInRequest() throws Exception {
    ...
    String dataPayload =
        TestUtilities.getResourceAsString("updateTest/DuplicateMnemonicsDataPayload.json");
  ...
  void shouldCreateAnUpdateInStoreQueryWithoutEmptyArrays() throws Exception {
    ...
    String expectedJson =
        TestUtilities.getResourceAsString("updateTest/WellCountryUpdateResult1311.json");
  ...
  void shouldCreateTrajectoryWithUid() throws Exception {
    ...
    String actualUid =
        this.delegator.createObject(
            traj, "goodUsername", "goodPassword", "exchangeID", this.mockClient);
  ...
  void shouldCreateLog1411() throws Exception {
    ...
    com.hashmapinc.tempus.WitsmlObjects.v1411.ObjLogs logs =
        WitsmlMarshal.deserialize(rawXML, com.hashmapinc.tempus.WitsmlObjects.v1411.ObjLogs.class);
    ...
    when(respCS.getBody())
        .thenReturn("{\"uid\": \"" + log.getUid() + "\"," + "\"uuid\": \"testUUID\"}");
    ...
    String actualUid =
        this.delegator.createObject(
            log, "goodUsername", "goodPassword", "exchangeID", this.mockClient);
  ...
  void shouldUpdateTrajectory1311() throws Exception {
    ...
    this.delegator.updateObject(
        traj1311, "goodUsername", "goodPassword", "exchangeID", this.mockClient);
  ...
  void shouldUpdateTrajectory1411() throws Exception {
    ...
    // test
    this.delegator.updateObject(
        traj1411, "goodUsername", "goodPassword", "exchangeID", this.mockClient);
