...
import com.hashmapinc.tempus.witsml.server.api.model.cap.v1311.CsContact;
import com.hashmapinc.tempus.witsml.server.api.model.cap.v1311.CsFunction;
import com.hashmapinc.tempus.witsml.server.api.model.cap.v1311.ObjCapServer;
import com.hashmapinc.tempus.witsml.server.api.model.cap.v1311.ObjCapServers;
import com.hashmapinc.tempus.witsml.server.api.model.cap.v1311.ObjectFactory;
...
public class ServerCap {
   ...
   *
   * @param supportUomConversion Whether or not the server supports uom conversion (true yes, false
   *     no)
   */
  ...
  private String get1411Object() throws JAXBException {
    // Create root
    com.hashmapinc.tempus.witsml.server.api.model.cap.v1411.ObjCapServers servers =
        new com.hashmapinc.tempus.witsml.server.api.model.cap.v1411.ObjCapServers();
    servers.setVersion("1.4.1");

    // Create server
    com.hashmapinc.tempus.witsml.server.api.model.cap.v1411.ObjCapServer server =
        new com.hashmapinc.tempus.witsml.server.api.model.cap.v1411.ObjCapServer();
    server.setApiVers("1.4.1");

    // Add Contact
    com.hashmapinc.tempus.witsml.server.api.model.cap.v1411.CsContact contact =
        new com.hashmapinc.tempus.witsml.server.api.model.cap.v1411.CsContact();
    contact.setName(contactName);
    contact.setEmail(contactEmail);
    contact.setPhone(contactPhone);
    server.setContact(contact);
    ...
    JAXBContext jaxbContext =
        JAXBContext.newInstance(
            com.hashmapinc.tempus.witsml.server.api.model.cap.v1411.ObjCapServers.class);
    Marshaller jaxbMarshaller = jaxbContext.createMarshaller();
    StringWriter writer = new StringWriter();
